...
var player,player_running,gameover, gameoverimg,restart , restartImg;
var bgimg,dogfoodimg,pointsound,player_collided,ibgroup;
...
function setup(){
  ...
  invisibleboundaries1 = createSprite(250 ,200, 500, 1500);
  invisibleboundaries1.visible = false;
  invisibleboundaries2 = createSprite(1300,200, 500, 1500);
  ...
  foodGroup = new Group();
  ibgroup = new Group();
  ibgroup.add(invisibleboundaries1,invisibleboundaries2);
  score = 0;
}
function draw(){
  background(180);
  ...
  if(ibgroup.y>150){
     ibgroup = ibgroup.height/2;
  }

  //if(invisibleboundaries2.y>100){
   // invisibleboundaries2= invisibleboundaries2.height/2;
...
function reset(){
  ...
  dog.changeAnimation("running",dogani);
